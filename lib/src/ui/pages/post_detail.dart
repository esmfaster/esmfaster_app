            ...
            return snapshot.hasData && snapshot.data != null ? ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(parseHtmlString(snapshot.data!.title.rendered), style: Theme.of(context).textTheme.headlineSmall),
                ),
                /*Padding(
                  padding: const EdgeInsets.fromLTRB(16.0, 4.0, 16.0, 16),
                  child: Text(parseHtmlString(snapshot.data!.excerpt.rendered), style: Theme.of(context).textTheme.titleMedium),
                ),*/
                Padding(
