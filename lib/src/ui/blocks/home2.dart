...
class _Home2State extends State<Home2> with TickerProviderStateMixin {
    ...
    return ScopedModelDescendant<AppStateModel>(
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Builder(
                builder: (context) {
                  return buildHomeTitle(context, model.blocks.settings.appBarStyle, model.blocks.settings.menuIcon);
                }
            ),
  ...
  Widget buildHomeTitle(BuildContext context, AppBarStyle appBarStyle, String menuIcon) {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: InkWell(
                ...
                child: DunesIcon(iconString: menuIcon),
              ),
            ),
            if(!appBarStyle.drawer)
              Container(
                        ...
                        children: [
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              prefixIcon: DunesIcon(iconString: appStateModel.blocks.settings.searchIcon),
                            ),
                          ),
            ...
            Stack(
              ...
              children: <Widget>[
                InkWell(
                  ...
                  child: DunesIcon(iconString: AppStateModel().blocks.settings.cartIcon),
                ),
                Positioned(
                  top: -4,
                  right: 0.0,
                  child: InkWell(
                    ...
                    child: context.select((ShoppingCart c) => c.count) != 0 ? Card(
                        ...
                        child: Container(
                            ...
                            constraints: BoxConstraints(minWidth: 16.0, minHeight: 16),
                            child: Center(
                                child: Text(
