...
class _CategoryScrollState extends State<CategoryScroll> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color captionColor = theme.colorScheme.error;

    //final tileTheme = ListTileTheme.of(context);
    //final Color color = tileTheme.textColor!;
    TextStyle titleStyle = theme.textTheme.titleMedium!.copyWith(fontSize: 12);
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  height: widget.block.childHeight + 44,
...
class _CategoryCardStyleState extends State<CategoryCardStyle> {
  ...
  Widget build(BuildContext context) {
    ...
    final tileTheme = ListTileTheme.of(context);
    final Color? color = tileTheme.textColor;
    TextStyle titleStyle = widget.block.textStyle != null ? getTextStyle(widget.block.textStyle!, context) : theme.textTheme.bodySmall!.copyWith(color: color, fontSize: 12);
    bool isDark = Theme.of(context).brightness == Brightness.dark;
