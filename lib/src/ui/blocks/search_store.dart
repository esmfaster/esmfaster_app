                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text('Popular Search', style: Theme.of(context).textTheme.titleMedium),
                            ),
                            Padding(
          ...
          Padding(
            ...
            child: TextButton(
                style: ElevatedButton.styleFrom(
                    backgroundColor: Theme.of(context).brightness == Brightness.dark ? Color(0xff696969) : Color(0xfff2f2f2),
