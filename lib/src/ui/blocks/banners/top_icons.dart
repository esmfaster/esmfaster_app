                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 8,),
                                Text(model.blocks.localeText.account, style: Theme.of(context).textTheme.bodySmall)
                              ],
                            ),
                          ),
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 8,),
                                Text(model.blocks.localeText.category, style: Theme.of(context).textTheme.bodySmall)
                              ],
                            ),
                          ),
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 8,),
                                Text(model.blocks.localeText.wishlist, style: Theme.of(context).textTheme.bodySmall)
                              ],
                            ),
                          ),
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(model.blocks.localeText.cart, style: Theme.of(context).textTheme.bodySmall)
                              ],
                            ),
                          ),
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(model.blocks.localeText.wallet, style: Theme.of(context).textTheme.bodySmall)
                              ],
                            ),
                          ),
