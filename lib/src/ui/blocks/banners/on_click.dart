...
import 'package:app/src/ui/products/products/new_products.dart';
...
onItemClick(MenuItem data, BuildContext context) async {
  if (data.linkId.isNotEmpty) {
    if (data.linkType == 'category') {
      ...
      var child = MenuItem(linkId: data.linkId, linkType: 'page');
      ...
      var child = MenuItem(linkId: data.linkId, linkType: 'post');
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => WPPostPage(child: child)));
