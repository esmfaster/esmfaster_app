      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(parseHtmlString(widget.post.title.rendered), style: Theme.of(context).textTheme.headlineSmall),
          ),
          Padding(
          ...
          Padding(
            ...
            child: Text(parseHtmlString(widget.post.excerpt.rendered), style: Theme.of(context).textTheme.titleMedium),
          ),
          Padding(
            padding: const EdgeInsets.fromLTRB(16.0, 4.0, 16.0, 16),
            child: Html(
