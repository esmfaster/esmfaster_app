...
class _CheckoutOnePageState extends State<CheckoutOnePage> {
  ...
  List<Widget> slivers(AsyncSnapshot<OrderReviewModel> snapshot,
    ...
    TextStyle subhead = Theme.of(context).textTheme.headlineSmall!;
                    ...
                    return Center(
                      child: Container(
                          ...
                          child: Html(data: snapshot.data!.messages, style: {
                            "*": Style(color: Theme.of(context).colorScheme.error),
  ...
  _buildOrderList(AsyncSnapshot<OrderReviewModel> snapshot) {
    final smallAmountStyle = Theme.of(context).textTheme.bodySmall;
...
print(widget.checkoutFormBloc.formData['payment_method']);
  ...
  /*Future<void> processPayStack(BuildContext context, AsyncSnapshot<OrderReviewModel> snapshot, OrderResult orderResult) async {
    // TODO Uncomment for PayStackPayment
        ...
        return SliverToBoxAdapter(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('How to pay', style: Theme.of(context).textTheme.headlineSmall,),
                Padding(
