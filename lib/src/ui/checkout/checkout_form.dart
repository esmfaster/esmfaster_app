...
//import 'package:app/src/ui/home/place_picker2.dart';
import 'dart:io';
                              ...
                              MaterialPageRoute(
                                builder: (context) => PlacePicker(
                                  ...
                                  onPlacePicked: (LocationResult result) async {
                                    ...
                                    // Store in app state
                                    await widget.appStateModel.setPickedLocation(pickedLocation);
    ...
    snapshot.data!.fieldgroups.billing.forEach((element) {
      ...
      if(element.label.isNotEmpty) {
        if((element.type.isEmpty || element.type == 'text') && element.label != 'Delivery Location' && !['lpac_longitude', 'lpac_latitude', 'lpac_is_map_shown', 'lpac_places_autocomplete'].contains(element.key)) {
          ...
          if (element.key == 'billing_postcode' || element.key == 'shipping_postcode') {
            list.add(
              Padding(
