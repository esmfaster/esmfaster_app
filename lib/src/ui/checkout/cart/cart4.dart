                  ...
                  new ButtonBar(
                    ...
                    children: <Widget>[
                      ...
                      TextButton(onPressed: () {
                        context.read<ShoppingCart>().redeemRewardPoints(context);
...
class ShoppingCartSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final largeAmountStyle = Theme.of(context).textTheme.headlineSmall;
...
class _ShoppingCartRowState extends State<ShoppingCartRow> {
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text(parseHtmlString(widget.product.name), maxLines: 2, style: Theme.of(context).textTheme.titleMedium!.copyWith(
            fontSize: 18,
          )),
          subtitle: Column(
            ...
            children: [
              ...
              /*if(bookingWidget != null)
                bookingWidget,*/
              Text(parseHtmlString(widget.product.formattedPrice), style: Theme.of(context).textTheme.bodyMedium,),
              SizedBox(height: 4),
  ...
  Widget buildCartCountButton(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        InkWell(
          onTap: () => context.read<ShoppingCart>().removeItemFromCart(widget.product.key),
      ...
      : TextField(
          ...
          onSubmitted: (val) async {
            ...
            if (newQty != null && newQty > 0) {
              ...
              await context.read<ShoppingCart>().updateCartQty(
                context,
                newQty,
                cartContent: widget.product,
              );
              setState(() {
                isLoading = false;
              });
