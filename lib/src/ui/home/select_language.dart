...
class _SelectLanguageState extends State<SelectLanguage> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle header6 = Theme.of(context).textTheme.headlineSmall.copyWith(
      fontSize: 18
    );
    return Scaffold(
      ...
      body: ScopedModelDescendant<AppStateModel>(
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 24),
                Text(model.blocks.localeText.welcome, style: Theme.of(context).textTheme.headlineSmall!.copyWith(
                    fontSize: 22
                )),
                Center(child: Logo()),
