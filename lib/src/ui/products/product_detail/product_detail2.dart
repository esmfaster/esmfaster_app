...
class _ProductDetail2State extends State<ProductDetail2> {
  ...
  _buildSlivers(BuildContext context, Product product) {
    ...
    if(product.vendor.name.isNotEmpty &&
        product.vendor.icon.isNotEmpty) {
      list.add(buildStore(product));
    }
    ...
    //list.add(ReviewList(productDetailBloc: widget.productDetailBloc)); //WhyShoppersLoveWidget
    ...
    return SliverToBoxAdapter(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(product.name, style: Theme.of(context).textTheme.titleMedium?.copyWith(
      ...
      delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
        return Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(product.attributes[index].name, style: Theme.of(context).textTheme.titleMedium,),
