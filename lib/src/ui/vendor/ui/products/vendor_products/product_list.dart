...
class Price extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          double.parse(product.salePrice) != 0 ? Text(formatter.format(double.parse(product.salePrice)), style: Theme.of(context).textTheme.titleMedium) : double.parse(product.price) != 0 ? Text(formatter.format(double.parse(product.price)), style: Theme.of(context).textTheme.titleMedium) : Container(),
          SizedBox(width: 4),
