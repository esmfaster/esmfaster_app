...
class _OTPVerificationState extends State<OTPVerification> {
  ...
  loginWithPhoneNumber(BuildContext context) async {
    ...
    bool status = await loginWordpress(context);
    return status;
  }

  Future<bool> loginWordpress(BuildContext context) async {
    var data = new Map<String, dynamic>();
    data["smsOTP"] = otpTextController.text;
    data["verificationId"] = verificationId;
    data["phoneNumber"] = widget.phoneNumber;
    bool status = await widget.accountBloc.submitLogin(context, data);
    if (status) {
