...
import 'package:app/src/ui/accounts/login/otp_login/otp_authentication.dart';
                ...
                if(appStateModel.blocks.settings.otpLogin)
                  IconButton(
                      onPressed: () async {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => AllPhoneAuthentication(),
                          ),
                        );
                      },
                      icon: const Icon(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 4.0),
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(backgroundColor: Color(0xFFEA4335), foregroundColor: Colors.white),
              onPressed: () async {
                bool status =await widget.accountBloc.signInWithGoogle(context);
                if (status) {
                  Navigator.popUntil(
            ...
            const SizedBox(height: 4.0),
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF34B7F1), foregroundColor: Colors.white),
              onPressed: () async {
                Navigator.of(context).push(
                  MaterialPageRoute(
            ...
            const SizedBox(height: 4.0),
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF3b5998), foregroundColor: Colors.white),
              onPressed: () async {
