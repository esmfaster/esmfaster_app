...
class AccountPage8 extends StatefulWidget {
  @override
  _AccountPage8State createState() => _AccountPage8State();
}

class _AccountPage8State extends State<AccountPage8> {
  ...
  List<Widget> _buildList(AppStateModel model) {
    ...
    list.add(SliverToBoxAdapter(child: SizedBox(height: 120)));
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: -40,
          right: -20,
          child: _buildCircleContainer(context, 120),
        ),
        Positioned(
          top: 120,
          right: -20,
          child: _buildCircleContainer(context, 55),
        ),
        Positioned(
          top: 10,
          left: 80,
        ...
        Positioned(
          top: -10,
          left: -40,
          child: _buildCircleContainer(context, 220),
        ),
        Positioned(
          top: 0,
          left: -5,
