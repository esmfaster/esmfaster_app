...
class _Categories1State extends State<Categories1> {
    ...
    return ScopedModelDescendant<AppStateModel>(
      builder: (context, child, model) {
        if (model.blocks.categories.length > 0) {
          ...
          return buildList(context, model.blocks);
        }
        return Scaffold(
            appBar: AppBar(
  ...
  buildList(BuildContext context, BlocksModel snapshot) {
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext ctxt, int index) {
                              return CategoryItem(subCategories[index], index, snapshot.categories, context);
                            }),
                      ),
                    )
                  ],
  ...
  Widget CategoryItem(
      Category category, int i, List<Category> categories, BuildContext context) {
    return InkWell(
      onTap: () {
