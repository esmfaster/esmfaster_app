...
class Settings {
  ...
  bool catalogueMode;
  MenuItem? homeFloatingButton;
  MenuItem? accountFloatingButton;
  bool buyNowButton;
  OrderSettings orderSettings;
  String appleAppName;
  String appleAppID;
  List<MenuItem> floatingButtons;
  String? logo;
  String? darkLogo;
  ...
  factory Settings.fromJson(Map<String, dynamic> json) => Settings(
    ...
    homeFloatingButton: json["homeFloatingButton"] == null ? null : MenuItem.fromJson(json["homeFloatingButton"]),
    accountFloatingButton: json["accountFloatingButton"] == null ? null : MenuItem.fromJson(json["accountFloatingButton"]),
    ...
    floatingButtons: json["floatingButtons"] == null ? [] : List<MenuItem>.from(json["floatingButtons"].map((x) => MenuItem.fromJson(x))),
    ...
    productListType: json["productListType"] == null ? 'general' : json["productListType"],
    otpAuth: json["otpAuth"] == null ? '2factor' : json["otpAuth"],
  );
}
...
class AppBarStyle {
  ...
  factory AppBarStyle.fromJson(Map<String, dynamic> json) => AppBarStyle(
    ...
    actions: json["actions"] == null ? [] : List<MenuItem>.from(json["actions"].map((x) => MenuItem.fromJson(x))),
...
class Nonce {
  ...
  factory Nonce.fromJson(Map<String, dynamic> json) => Nonce(
    ...
    jckwds: json["jckwds"] == null ? '5c895bbe90' : json["jckwds"],
  );
}
...
class Block {
  ...
  factory Block.fromJson(Map<String, dynamic> json) => Block(
    ...
    children: _nullOrEmptyOrFalse(json["children"]) || json["children"] == '' ? [] : List<MenuItem>.from(json["children"].map((x) => MenuItem.fromJson(x))),
...
class AppTypography {
  ...
  factory AppTypography.fromJson(Map<String, dynamic> json) => AppTypography(
    ...
    bodyMedium: json["body_text_2"] == null ? BodyText.fromJson({}) : BodyText.fromJson(json["body_text_2"]),
    ...
    headlineSmall: json["headline_6"] == null ? BodyText.fromJson({}) : BodyText.fromJson(json["headline_6"]),
