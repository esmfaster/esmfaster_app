  ...
  return ThemeData(
    ...
    elevatedButtonTheme: _nullOrEmptyOrFalse(buttonTheme) ? ElevatedButtonThemeData(
        ...
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: _nullOrEmptyOrFalse(buttonTheme['primary']) ? Colors.blue : HexColor(buttonTheme['primary']),
          elevation: _nullOrEmptyOrFalse(buttonTheme['elevation']) ? 0.0 : double.parse(buttonTheme['elevation'].toString()),
          foregroundColor: _nullOrEmptyOrFalse(buttonTheme['onPrimary']) ? Colors.white : HexColor(buttonTheme['onPrimary']),
...
class BlockTextTheme {
  ...
  factory BlockTextTheme.fromJson(Map<String, dynamic> json) {
    return BlockTextTheme(
      ...
      headlineSmall: json['headlineSmall'] == null ? BlockTextStyle.fromJson({}) : BlockTextStyle.fromJson(json['headlineSmall'] as Map<String, dynamic>),
      ...
      bodyMedium: json['bodyMedium'] == null ? BlockTextStyle.fromJson({}) : BlockTextStyle.fromJson(json['bodyMedium'] as Map<String, dynamic>),
