...
class AccountBloc {
  ...
  Future<bool> signInWithGoogle(BuildContext context) async {
    ...
    if(googleUser != null) {
      ...
      bool status = await submitLogin(context, data);
  ...
  Future<bool> signInWithFacebook(BuildContext context) async {
    ...
    if(loginResult.accessToken?.tokenString != null) {
      ...
      // Login Wordpress
      var data = <String, dynamic>{};
      data["access_token"] = loginResult.accessToken!.tokenString;
  ...
  login(BuildContext context, Map<String, dynamic> loginData) async {
    ...
    bool status = await submitLogin(context, loginData);
...
/*  _login(BuildContext context, Map<String, dynamic> data) async {
  ...
  Future register(BuildContext context, Map<String, dynamic> registerData) async {
    bool status = await submitRegister(context, registerData);
    if (status) {
  ...
  Future<bool> submitLogin(BuildContext context, Map<String, dynamic> data) async {
  ...
  Future<bool> submitRegister(BuildContext context, Map<String, dynamic> data) async {
